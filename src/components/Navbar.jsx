  ...
  return (
    <nav className="bg-white shadow-md py-4 px-6 sticky top-0 z-50 border-b border-gray-200">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        {/* Counter Badges บน Navbar */}
        <div className="flex items-center space-x-3 text-sm font-medium">
          <span className="bg-rose-50 text-rose-600 px-3 py-1.5 rounded-full border border-rose-200 flex items-center gap-1 shadow-xs">
            ❤️ <span className="font-bold">{totalLikes}</span>
          </span>
          <span className="bg-amber-50 text-amber-800 px-3 py-1.5 rounded-full border border-amber-200 flex items-center gap-1.5 shadow-xs">
            🛒 ตะกร้า: 
